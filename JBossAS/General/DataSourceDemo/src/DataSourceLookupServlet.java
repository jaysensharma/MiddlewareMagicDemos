...
@WebServlet(value="/DataSourceLookupServlet")
public class DataSourceLookupServlet extends HttpServlet 
  {
        ...
        //commons logging
        private static Log logger = LogFactory.getLog(DataSourceLookupServlet.class);

        public void init() throws ServletException {
            try{
                 initialContext=new InitialContext();
                 dataSource = (DataSource) initialContext.lookup("java:jboss/exported/MySqlDS");
