...
@WebServlet(value="/DataSourceResourceRefServlet")
public class DataSourceResourceRefServlet extends HttpServlet 
  {
        ...
        //commons logging
        private static Log logger = LogFactory.getLog(DataSourceResourceRefServlet.class);

        public void init() throws ServletException {
            try{
                 initialContext=new InitialContext();
                 dataSource = (DataSource) initialContext.lookup("java:comp/env/some/SQL/Resource");
